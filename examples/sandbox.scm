...
(display "Iterating... ")
(set! result (iter 50000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(display result)
(newline)
(set! result (iter 50000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1 2 3))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1))))))
(set! result (iter 5000 (lambda (i) (+ i (vector-length (make-vector 1))))))
